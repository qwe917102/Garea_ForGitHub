...
(6, 0, 'gatest003@ggg.com', 'gatest003_191', '989d943b78b2ceaa8045b182182888e9a00a0e8a', '2b9b91b40e5c50e28ef24dc7440df7baf44f66b9', '0956666333', 0, '', '2019-08-14 16:07:08');
...
(89, '4', '2', '【msi微星】Interceptor DS4200 電競鍵盤', 'MSI_products/DS4200.png', ' ● DS4200 類機械式電競鍵盤 ● 機械般的觸感 ● 背光控制 可設定3種模式效果(關閉/恆亮/呼吸)', '1,990', 1990, '1', 'MSI_products/DS4200(1).jpg', 'MSI_products/DS4200(2).jpg', '2-2', 'rule.jpg', ''),
...
--
ALTER TABLE `members`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT COMMENT '會員編號', AUTO_INCREMENT=7;
